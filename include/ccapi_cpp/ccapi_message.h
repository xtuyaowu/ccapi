...
class Message CCAPI_FINAL {
 public:
  ...
  enum class Type {
    ...
    EXECUTION_MANAGEMENT_EVENTS_BALANCE_POSITION_UPDATE,
  ...
  static std::string typeToString(Type type) {
    ...
    switch (type) {
      ...
      case Type::EXECUTION_MANAGEMENT_EVENTS_BALANCE_UPDATE:
        ...
        break;
      case Type::EXECUTION_MANAGEMENT_EVENTS_BALANCE_POSITION_UPDATE:
        output = "EXECUTION_MANAGEMENT_EVENTS_BALANCE_POSITION_UPDATE";
        break;

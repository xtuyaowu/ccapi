#ifndef INCLUDE_CCAPI_CPP_SERVICE_CCAPI_MARKET_DATA_SERVICE_BITSO_H_
#define INCLUDE_CCAPI_CPP_SERVICE_CCAPI_MARKET_DATA_SERVICE_BITSO_H_
#ifdef CCAPI_ENABLE_SERVICE_MARKET_DATA
#ifdef CCAPI_ENABLE_EXCHANGE_BITSO
#include "ccapi_cpp/service/ccapi_market_data_service.h"
namespace ccapi {
class MarketDataServiceBitso : public MarketDataService {
 public:
  MarketDataServiceBitso(std::function<void(Event&, Queue<Event>*)> eventHandler, SessionOptions sessionOptions, SessionConfigs sessionConfigs,
                          std::shared_ptr<ServiceContext> serviceContextPtr)
      : MarketDataService(eventHandler, sessionOptions, sessionConfigs, serviceContextPtr) {
    this->exchangeName = CCAPI_EXCHANGE_NAME_BITSO;
  ...
  virtual ~MarketDataServiceBitso() {}
...
//        rj::Value("subscribe");
        rj::Value symbolIdValue;
        symbolIdValue.SetString(rj::StringRef(symbolId.c_str(), symbolId.length()));
        rj::Value channelIdValue;
        channelIdValue.SetString(rj::StringRef(channelId.c_str(), symbolId.length()));

        document.AddMember("book", symbolIdValue.Move(), allocator);
        document.AddMember("type", channelIdValue.Move(), allocator);
...
#endif
#endif
#endif  // INCLUDE_CCAPI_CPP_SERVICE_CCAPI_MARKET_DATA_SERVICE_BITSO_H_